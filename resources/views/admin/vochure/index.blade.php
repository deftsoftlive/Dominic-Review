                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <div class="cst-admin-filter">
                                                ...
                                                <a href="{{ route('admin.vochure.list') }}" class="btn btn-primary">All Voucher</a>
                                                <a href="{{ route('admin.vochure.active') }}" class="btn btn-primary">Active Voucher</a>
                                                <a href="{{ route('admin.vochure.inactive') }}" class="btn btn-primary">Inactive Voucher</a>
                                            </div>
                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                ...
                                                                <div class="dropdown-menu" role="menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(82px, -64px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                                    <a href="{{url('admin/vouchure')}}/{{$test->slug}}" class="dropdown-item">Edit</a>

                                                                    <a href="{{route('admin.vochure.status',$test->id)}}" class="dropdown-item">
                                                                        @if($test->status == '1')
                                                                            In-active
                                                                        @else
                                                                            Active

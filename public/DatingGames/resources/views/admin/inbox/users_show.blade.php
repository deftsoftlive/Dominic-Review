...
<aside class="right-side">               
    ...
    <section class="content">
            <div class="row">
                <div class="col-sm-7">
                    <form action="{{ route('admin.searchUser') }}" method="POST" class="sidebar-form">
                            @csrf
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$user->email}}</td>
                                    <td>
                                    <a class="btn btn-primary" href="{{route('admin.matchedUser',['slug'=>$user->slug])}}">View User Matches
                                    </a>
                                    </td>
                                </tr>
                                 @endforeach

                    ...
                    <form id="register" class="register-form" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                ...
                                <!-- <input id="date" type="text" class="form-control{{ $errors->has('date_of_birth') ? ' is-invalid' : '' }} textbox-n" name="date_of_birth" value="{{ old('date_of_birth') }}" required autofocus placeholder="D.O.B - dd/mm/yyy" onfocus="(this.type='date')"> -->

                                <input type="text" class="form-control textbox-n {{ $errors->has('date_of_birth') ? ' is-invalid' : '' }}" name="date_of_birth" placeholder="D.O.B - dd/mm/yyyy" onfocus="(this.type='date')" id="date" value="{{ old('date_of_birth') }}">

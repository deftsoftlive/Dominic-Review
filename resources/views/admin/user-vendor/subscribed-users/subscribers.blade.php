            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header" style="justify-content: normal;float:right;">
                        ...
                        <a href="{{url('admin/subscribed-users')}}" class="btn btn-primary d-print-none" style="color:white;">All Subscribed Users</a>
                        <a href="#" onclick="window.print();" class="btn btn-primary d-print-none" style="color:white;">Print</a>
                        <a href="{{route('send_subscriber_email')}}" class="btn btn-primary d-print-none" style="color:white;">Send Email</a>
                    </div>
                      ...
                      @include('admin.error_message')
                        <table class="table table-hover">
                            ...
                            <tr> 
                                ...
                                <th class="d-print-none">Unsubscribed By</th>
                            ...
                            @if(!empty($users->email))
                                <tr>
                                    ...
                                    <td class="d-print-none">@if($users->unsubscribed_by == 1) Admin @else User @endif</td>

                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <div class="cst-admin-filter">
                                                ...
                                                <a href="{{ route('admin.badge.list') }}" class="btn btn-primary">All Badges</a>
                                                <a href="{{ route('admin.badge.active') }}" class="btn btn-primary">Active Badges</a>
                                                <a href="{{ route('admin.badge.inactive') }}" class="btn btn-primary">In-active Badges</a>
                                            </div>
                                        ...
                                        <div class="table-responsive">
                                          @include('admin.error_message')
                                            <table class="table table-hover">
                                                ...
                                                @foreach($badge as $bd)
                                                    <tr>
                                                        <td><input type="text" id="update_badge_sort" data-id="{{$bd->id}}" value="{{$bd->sort}}" style="width:
                                                        50px"></td>
                                                        <td>
                                                        @if($bd->status == '1')

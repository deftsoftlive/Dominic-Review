                ...
                <!--  <form action="{{route('save-contact-us')}}" id="contact_form" method="POST" class="cstm-cont-page cst_course_form taster_form">
                      ...
                      <div class="form-group row gender-opt contact-gender courses-gender">  
                          ...
                          <div class="col-md-12 det-gender-opt">
                              ...
                              <input type="radio" id="male2" name="participant_gender" value="male">
                              <label for="male2">Male</label>
                              <input type="radio" id="female2" name="participant_gender" value="female">
      ...
      <div class="container">
        <div class="row">
              ...
              <div class="form-group col-lg-3 col-md-4">
                ...
                <select id="course_type" name="course_type" class="form-control event-dropdown">                    
                  ...
                  <div class="form-group col-lg-2 col-md-2 col-sm-6 col-6">
                    ...
                    <a href="{{route('school-listing')}}?&cat={{isset($cat) ? $cat : ''}}" id="course_search_submit" class="cstm-btn main_button">Reset</a>
                  </div>
                  </div>
                  </form>
          </div>
          ...
          @php 
            ...
            $early_bird_school_dis = getAllValueWithMeta('school_percentage', 'early-bird');
                    ...
                    @else
                      @if($early_bird_enable == '1')
                        @php 
                          ...
                          $dis_price = $cour_price - (($cour_price) * ($early_bird_school_dis/100));
                        @endphp
        ...
        <div class="row">
          <div class="col-md-8 offset-md-2">
            <div class="click-sec-content">
              <h2 class="click-sec-tagline">{{ getAllValueWithMeta('section4_title', 'school-course-listing') }}</h2>
                ...
                <li>
                  <a href="{{ getAllValueWithMeta('school_course_section4_button_url', 'school-course-listing') }}" class="cstm-btn main_button">{{ getAllValueWithMeta('school_course_section4_button_title', 'school-course-listing') }}</a>
                </li>
                <li>
                    <figure>
                    <img src="{{ URL::asset('/images/click-btn-img.png')}}">

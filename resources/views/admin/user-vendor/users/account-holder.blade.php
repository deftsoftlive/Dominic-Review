    ...
    <div class="container">
        <div class="inner-cont">
            ...
            <div class="back-to-family">
                ...
                <a href="{{url('/user/my-family')}}" class="btn btn-primary">Back to my family</a>
            </div>
            @endif
            <br/>
            <div id="accordion" class="parent_fam_mem">
                <div class="card">
                    <div class="card-header family-tabs" id="headingOne">
                        <h5 class="mb-0">
                            <button class="btn btn-link @if($sec == 1) collapsed @endif" data-toggle="collapse" data-target="#collapseOne" @if($sec == 1) aria-expanded="true" @else aria-expanded="false" @endif aria-controls="collapseOne">
                    ...
                    <div id="collapseOne" class="collapse @if($sec == 1) show @endif" aria-labelledby="headingOne" data-parent="#accordion" style="">
                        <div class="card-body">
                            <div class="register-sec form-register-sec family_mem ">

                                <form id="add-family-mem" action="{{route('ah_admin_participants_details')}}" class="register-form" method="POST" novalidate="novalidate">
                                    @csrf
                ...
                <div class="card  ">
                    <div class="card-header family-tabs" id="headingTwo">
                        <h5 class="mb-0">
                            <button class="btn btn-link @if($sec == 2) collapsed @endif" data-toggle="collapse" data-target="#collapseTwo" @if($sec == 2) aria-expanded="true" @else aria-expanded="false" @endif aria-controls="collapseTwo">
                        ...
                        <div class="card-body">
                            <!-- <div class="card-body"> -->
                                <div class="register-sec form-register-sec family_mem ">
                                    <div class="form-partition">
                                        <div class="row">
                                            <form action="{{route('ah_admin_contact_information')}}" class="register-form contact_form" method="POST">
                                                @csrf
                        ...
                        <div class="card-body">
                            <div class="register-sec form-register-sec family_mem ">
                                <div class="form-partition">
                                    ...
                                    <form action="{{route('ah_admin_medical_information')}}" class="register-form contact_form medicical-form" method="POST">
                                        @csrf
                                        <input type="hidden" name="child_id" value="{{$user->id}}">
                                        <input type="hidden" name="type" value="Account Holder">
                            ...
                            <div class="register-sec form-register-sec family_mem ">
                                <div class="form-partition">
                                    <div class="row">
                                        ...
                                        <form action="{{route('ah_admin_media_consent')}}" class="register-form contact_form" method="POST">
                                            @csrf

        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">BANNER SECTION</h5>
             {{textbox($errors,'Banner Title <span class="cst-upper-star">*</span>','school_course_page_title',$school_course_page_title)}}

             <div class="form-group">
              <label class="label-file control-label">Banner Image  (1920 X 350)<span class="cst-upper-star">*</span></label>
              <input type="file" accept="image/*" onchange="ValidateSingleInput(this, 'school_course_banner_image_src')" class="form-control" name="school_course_banner_image">
             </div>
             <img id="school_course_banner_image_src" src="{{ URL::asset('/uploads').'/'.$school_course_banner_image }}" style="width: 100px;" />
          </div>
        </div>
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title"><u>COURSE/CAMP LINKING SECTION</u></h5>
             {{textbox($errors,'Title <span class="cst-upper-star">*</span>', 'school_course_section4_title', $school_course_section4_title)}}
             {{textbox($errors,'Button Title <span class="cst-upper-star">*</span>', 'school_course_section4_button_title', $school_course_section4_button_title)}}
             {{textbox($errors,'Button Url <span class="cst-upper-star">*</span>', 'school_course_section4_button_url', $school_course_section4_button_url)}}
          </div>
        </div>

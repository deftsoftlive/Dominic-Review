...
|*************************************** -->
    <section class="football-course-sec" style="background: url({{$base_url}}/public/uploads/{{ getAllValueWithMeta('football_course_banner_image', 'football-course-listing') }});">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="football-course-content">
              <h2 class="f-course-heading">{{ getAllValueWithMeta('football_course_page_title', 'football-course-listing') }}</h2>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          ...
          @php 
            ...
            $early_bird_football_dis = getAllValueWithMeta('football_percentage', 'early-bird');
                    ...
                    @else
                      @if($early_bird_enable == '1')
                        @php 
                          ...
                          $dis_price = $cour_price - (($cour_price) * ($early_bird_football_dis/100));
                        @endphp
        ...
        <div class="row">
          <div class="col-md-8 offset-md-2">
            <div class="click-sec-content">
              <h2 class="click-sec-tagline">{{ getAllValueWithMeta('football_course_section4_title', 'football-course-listing') }}</h2>

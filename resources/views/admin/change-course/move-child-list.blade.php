                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="cst-admin-filter">
                            <a href="{{ route('add_course_for_player') }}" class="btn btn-primary">Assign player to course</a>
                        </div>
                        </div>
                        <br/>

                        <!-- Filter Section - Start -->
                        <form action="{{route('purchased_course_data')}}" method="POST" class="cst-selection">
                        @csrf
                            <div class="container">
                                <div class="row">
                                    <div class="col-sm-3">

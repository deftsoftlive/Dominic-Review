...
<div class="form-group ">
  ...
  <div class="col-md-6">
  	  <div class="form-group">
  	  	  ...
  	  	  <input type="text" min="0" name="price" value="{{$price}}" class="form-control" id="Reqularprice">
  	  </div>
  </div>
<!-- field start -->
<!-- field start -->
  <div class="col-md-6">
  	  <div class="form-group">
  	  	  ...
  	  	  <input type="text" min="0" name="sale_price" class="form-control" value="{{$sale_price}}">
  	  </div>
  </div>
<!-- field start -->

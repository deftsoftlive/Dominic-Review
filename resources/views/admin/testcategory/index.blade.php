                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                ...
                                                                <div class="dropdown-menu" role="menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(82px, -64px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                                    <a href="{{url('admin/testcategory')}}/{{$test->slug}}" class="dropdown-item">Edit</a>

                                                                    <a onclick="return confirm('Are you sure you want to delete this test category?')" href="{{url('admin/testcategory/delete')}}/{{$test->id}}" class="dropdown-item">Delete</a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>

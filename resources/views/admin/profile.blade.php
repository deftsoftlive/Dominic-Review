                ...
                <div class="profile-card">
                  @csrf
                   <div class="profile-image">
                         ...
                         <img id="image_src" class="img-radius" style="width: 100px; height: 100px; margin-top: 6px;" src="{{ Auth::User()->profile_image ? url('/').'/'.Auth::User()->profile_image : asset('/images/user.jpg') }}">

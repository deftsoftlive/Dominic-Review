...
|*************************************** -->
    <section class="football-course-sec" style="background: url({{$base_url}}/public/uploads/{{ getAllValueWithMeta('tennis_course_banner_image', 'tennis-course-listing') }});">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="football-course-content">
              <h2 class="f-course-heading">{{ getAllValueWithMeta('tennis_course_page_title', 'tennis-course-listing') }}</h2>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="col-md-8 offset-md-2">
            <div class="click-sec-content">
              <h2 class="click-sec-tagline">{{ getAllValueWithMeta('tennis_course_section4_title', 'tennis-course-listing') }}</h2>
                ...
                <li>
                  <a href="{{ getAllValueWithMeta('section4_button_url', 'tennis-course-listing') }}" class="cstm-btn">{{ getAllValueWithMeta('tennis_course_section4_button_title', 'tennis-course-listing') }}</a>
                </li>
                <li>
                    <figure>
                    <img src="{{ URL::asset('/images/click-btn-img.png')}}">

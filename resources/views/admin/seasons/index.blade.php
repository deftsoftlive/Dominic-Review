                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <div class="cst-admin-filter">
                                                ...
                                                <a href="{{ route('admin.seasons.list') }}" class="btn btn-primary">All Seasons</a>
                                                <a href="{{ route('admin.seasons.active') }}" class="btn btn-primary">Active Seasons</a>
                                                <a href="{{ route('admin.seasons.inactive') }}" class="btn btn-primary">In-active Seasons</a>
                                            </div>
                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                ...
                                                                <div class="dropdown-menu" role="menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(82px, -64px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                                    <a href="{{url('admin/seasons')}}/{{$test->slug}}" class="dropdown-item">Edit</a>

                                                                    <a href="{{route('admin.seasons.status',$test->slug)}}" class="dropdown-item">
                                                                        @if($test->status == '1')
                                                                            In-active
                                                                        @else
                                                                            Active
                                                                    ...
                                                                    <a onclick="return confirm('Are you sure you want to delete this season?')" href="{{url('admin/seasons/delete')}}/{{$test->id}}" class="dropdown-item">Delete</a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>

                        ...
                        <table class="table table-hover">
                            ...
                            @php $player_name = getUsername($sh->player_id); @endphp 
                              <tr>
                                ...
                                <td><p>
                                    <a href="{{url('admin/player-report')}}/{{$sh->id}}">View Report</a>&nbsp;&nbsp;&nbsp;
                                    <a onclick="return confirm('Are you sure you want to delete this report?')" href="{{url('admin/player-report')}}/delete/{{$sh->id}}">Delete</a>
                                </p></td> 
                              </tr>
                            @endforeach
                            @else

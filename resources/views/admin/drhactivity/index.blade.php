                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu" role="menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(82px, -64px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                <a href="{{url('admin/drh-activity')}}/{{$test->slug}}" class="dropdown-item">Edit</a>

                                                <a href="{{route('admin.drhactivity.status',$test->id)}}" class="dropdown-item">
                                                    @if($test->status == '1')
                                                        In-active
                                                    @else
                                                        Active
                                                ...
                                                <a onclick="return confirm('Are you sure you want to delete this drh activity?')" href="{{url('admin/drhactivity/delete')}}/{{$test->id}}" class="dropdown-item">Delete</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>

                                                ...
                                                <div class="col-md-12 option_row consent-option-row">
                                                    <div class="form-group row ">
                                                        ...
                                                        <div class="radio-wrap">
                                                            <div class="cstm-radio">
                                                                <input type="radio" name="book_person_type" id="medical-yes1111">
                                                                <label for="medical-yes1111">Yes</label>
                                                            </div>
                                                            <div class="cstm-radio">
                                                                <input type="radio" name="book_person_type" id="medical-no1111"> <label for="medical-no1111">No</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 option_row consent-option-row">
                                                    <div class="form-group row ">
                                                        ...
                                                        <div class="radio-wrap">
                                                            <div class="cstm-radio">
                                                                <input type="radio" name="book_person_type" id="medical-yes2222">
                                                                <label for="medical-yes2222">Yes</label>
                                                            </div>
                                                            <div class="cstm-radio">
                                                                <input type="radio" name="book_person_type" id="medical-no2222"> <label for="medical-no2222">No</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>

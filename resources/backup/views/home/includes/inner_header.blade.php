        ...
        <div class="top-bar inner-header">
            <div class="container">
              <div class="top-inner-nav mob-hide"> 
                <a href="{{url('/')}}" class="brand-name"><img src="{{URL::asset('/images/fav-icon.png')}}"></a>
             ...
             <div class="top-Mob-nav">
                ...
                <a href="http://49.249.236.30:8654" class="brand-name"><img src="{{URL::asset('/images/fav-icon.png')}}"></a>
